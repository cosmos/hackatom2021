...
export default {
  props: {
    ...
    backgroundColor: {
      type: String,
      default: '#fff', // TODO: use a color variable
    },
    /**
     * CSS color of border
     */
    borderColor: {
      type: String,
      default: 'transition', // TODO: use a color variable
    },
    /**
     * CSS color of border
     */
    color: {
      type: String,
      default: '#000', // TODO: use a color variable
    },
    /**
     * Glow style
     */
...
.tm-button
  ...
  &__variant__contained
    ...
    &:hover,
    &:focus
      background: radial-gradient(31.57% 130.21% at 1.77% 100%, #320B93 0%, #FFFFFF 100%)
    &:active
      background: radial-gradient(102.53% 422.92% at 1.77% 100%, #320B93 0%, #FFFFFF 100%)
      color var(--white)
